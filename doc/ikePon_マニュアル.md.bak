...
| v1.2.0 | 2026-07-11 | メインウィンドウの縦横比を 16:9 に固定（最小サイズ 1200×720、最大化時も維持）。パッド・バンク D&D 入れ替えのパフォーマンス改善（音声の再ロードを廃止）。SE カテゴリの TapBehavior バッジ表示修正。 |
